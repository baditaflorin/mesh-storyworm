...
**Live → https://baditaflorin.github.io/mesh-storyworm/**

**Source → https://github.com/baditaflorin/mesh-storyworm**
...
git clone https://github.com/baditaflorin/mesh-storyworm
cd mesh-storyworm
npm install
npm run dev
```
...
- `mesh-storyworm:signalingUrl`
- `mesh-storyworm:turnTokenUrl`
- `mesh-storyworm:iceServers`
- `mesh-storyworm:room`
